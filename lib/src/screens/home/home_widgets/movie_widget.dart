...
class MovieWidget extends StatelessWidget {
  ...
  final String rating;
  final String deckP;
  final MovieDetailsProvider movieDetails;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        movieDetails.setMovieDetails(movieName, imagePath, rating, deckP);
        Navigator.of(context).pushNamed(AppRoute.movieDetailsScreen);
      },
      child: Padding(
